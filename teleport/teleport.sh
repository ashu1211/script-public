...
UPDATER_STYLE='none'
REPO_CHANNEL=''
TARGET_HOSTNAME='teleport.instanodes.io'
TARGET_PORT='443'
JOIN_TOKEN='7fe05c833550e81bf11e57b0edc77048'
JOIN_METHOD=''
JOIN_METHOD_FLAG=""
[ -n "$JOIN_METHOD" ] && JOIN_METHOD_FLAG="--join-method ${JOIN_METHOD}"

# inject labels into the configuration
LABELS="teleport.internal/resource-id=d445f740-0bbd-4657-9bef-b9fd1dd065e3"
LABELS_FLAG=()
...
CA_PIN_HASHES='sha256:2d444c903631674dd62d7a84064a6d01bcc9f489737c404b21897b12a3540ff3'
CA_PINS='sha256:2d444c903631674dd62d7a84064a6d01bcc9f489737c404b21897b12a3540ff3'
ARG_CA_PIN_HASHES=""
APP_INSTALL_MODE='false'
APP_NAME=''
APP_URI=''
DB_INSTALL_MODE='false'
DISCOVERY_INSTALL_MODE='false'
